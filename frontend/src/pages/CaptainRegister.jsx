    ...
    <div className="min-h-screen flex items-center justify-center bg-premium-dark relative overflow-hidden p-4">
      ...
      >
        <h1 className="text-3xl font-black text-white mb-2 text-center italic">
          TEAM <span className="text-blue-500">REGISTRATION</span>
        </h1>
        <p className="text-center text-gray-400 mb-8 text-sm text-balance">
          Register your team and captain credentials for the league
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-lg font-bold tracking-wide mt-2 shadow-lg shadow-blue-900/20"
          >
            CREATE CAPTAIN
          </button>
        </form>

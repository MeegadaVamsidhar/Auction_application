        ...
        <div className="min-h-screen flex items-center justify-center bg-premium-dark relative overflow-hidden p-4">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-black text-white italic mb-2">CAPTAIN <span className="text-blue-500">ACCESS</span></h1>
                    <p className="text-gray-400 text-xs uppercase tracking-widest">Team Management Portal</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-lg font-bold tracking-wide mt-2 shadow-lg shadow-blue-900/20 transition-all">
                        LOGIN TO SQUAD
                    </button>

                    <div className="text-center mt-6 space-y-2">
                        <Link to="/captain-register" className="block text-sm text-gray-500 hover:text-white transition-colors">
                            Need a Captain Account? <span className="text-blue-400">Register</span>
                        </Link>

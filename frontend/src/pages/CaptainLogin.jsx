  ...
  return (
    <div className="min-h-screen bg-premium-dark flex overflow-hidden font-sans">
      ...
      <div className="cinematic-bg fixed z-0">
        <div className="cinematic-glow w-[800px] h-[800px] -top-96 -right-96 bg-blue-600/10"></div>
        <div className="cinematic-glow w-[600px] h-[600px] bottom-0 left-0 bg-premium-gold/5"></div>

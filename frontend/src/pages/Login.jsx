    ...
    <div className="min-h-screen flex items-center justify-center bg-premium-dark relative overflow-hidden p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full btn-gold py-4 text-lg font-bold tracking-wide mt-2 shadow-lg shadow-premium-gold/20 hover:shadow-premium-gold/40 hover:-translate-y-1 transition-all"
          >
            ENTER ARENA
          </button>
          ...
          <div className="text-center mt-6">
            ...
            >
              ...
              <span className="text-premium-gold">Register here</span>
            </Link>
            <div className="mt-4">
              <Link
                to="/player-registration"
                className="text-xs text-gray-500 hover:text-premium-gold transition-colors"
              >
                Are you a player?{" "}
                <span className="underline">Register for the Auction Pool</span>
              </Link>
            </div>
          </div>
        </form>

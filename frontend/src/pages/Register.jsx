    ...
    <div className="min-h-screen flex items-center justify-center bg-premium-dark relative overflow-hidden p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full btn-gold py-4 text-lg mt-4 shadow-lg shadow-premium-gold/20 hover:shadow-premium-gold/40"
          >
            REGISTER ACCOUNT
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/login" className="text-premium-gold hover:underline">
              Login here
            </Link>
          </p>
        </div>

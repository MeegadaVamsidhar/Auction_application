      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="premium-card w-full max-w-md relative animate-float">
            ...
            <h2 className="text-xl font-bold mb-4 text-premium-gold">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, initialPurse: e.target.value })
                  }
                  className="w-full bg-black/50 border border-gray-700 rounded p-2 text-white"
                />
              </div>
              ...
              <button type="submit" className="w-full btn-gold py-2 mt-4">

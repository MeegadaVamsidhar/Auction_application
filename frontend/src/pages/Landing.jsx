    ...
    <div className="min-h-screen bg-premium-dark flex flex-col relative overflow-hidden">
      ...
      <nav className="w-full p-6 flex justify-between items-center relative z-20">
        ...
        <div className="text-xs font-mono opacity-50">
          The South Indian Cricket League
        </div>
      </nav>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16">
            ...
            <div className="md:w-1/2 text-left">
              ...
              >
                ...
                YOUR
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-premium-gold to-yellow-600">
                  LEGACY.
                </span>
              </motion.h1>
              <motion.p
              ...
              >
                The stage is set. Bidding wars begin now. Manage your squad, bid
                for stars, and create the ultimate team.
              </motion.p>
            </div>
            ...
            >
              ...
              <div className="glass-panel p-6 relative overflow-hidden">
                ...
                <h3 className="text-premium-gold font-bold text-sm mb-4 uppercase tracking-widest">
                  Auction Pulse
                </h3>
                  ...
                  <div className="bg-white/5 p-4 rounded-xl border border-white/5 col-span-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-[10px] font-bold text-premium-gold uppercase mb-1">
                          Success Rate
                        </div>
                ...
                <div className="space-y-3 max-h-[200px] overflow-y-auto pr-2 custom-scrollbar">
                  {stats.teamStats.length > 0 ? (
                    stats.teamStats.map((team, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/5 hover:border-white/20 transition-all"
                      >
                        ...
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <span className="block text-[8px] uppercase text-gray-500 font-bold">
                              Squad Size
                            </span>
            ...
            <Link to="/player-login" className="group">
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-bold text-premium-gold">
                    →
                  </span>
                </div>
                <h2 className="text-xl font-bold text-white mb-2">PLAYER</h2>
                <p className="text-sm text-gray-500 leading-relaxed mb-6">
                  View your auction status, sold price, and team allocation.
                </p>
                <Link
                  to="/players"
                  onClick={(e) => e.stopPropagation()}
                  className="inline-block bg-premium-gold/10 text-premium-gold border border-premium-gold/30 px-4 py-2 rounded text-[10px] font-bold uppercase hover:bg-premium-gold hover:text-black transition-all"
                >
                  See All Players
                </Link>
              </motion.div>
            ...
            <Link to="/captain-login" className="group">
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-bold text-blue-500">
                    →
                  </span>
                </div>
                <h2 className="text-xl font-bold text-white mb-2">CAPTAIN</h2>
                <p className="text-sm text-gray-500 leading-relaxed">
                  Enter the war room. Bid for players and build your squad.
                </p>
              </motion.div>
            </Link>
            ...
            <Link to="/admin-login" className="group">
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-bold text-red-500">
                    →
                  </span>
                </div>
                <h2 className="text-xl font-bold text-white mb-2">ADMIN</h2>
                <p className="text-sm text-gray-500 leading-relaxed">
                  Control the flow. Manage teams, players, and auction rules.
                </p>
              </motion.div>
            </Link>
          </div>

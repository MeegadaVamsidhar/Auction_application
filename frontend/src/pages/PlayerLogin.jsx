      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-black text-white italic mb-2">
            PLAYER <span className="text-premium-gold">STATUS</span>
          </h1>
          <p className="text-gray-400 text-xs uppercase tracking-widest">
            Enter mobile number to view status
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full btn-gold py-4 text-lg font-bold tracking-wide mt-2"
          >
            CHECK STATUS
          </button>
          ...
          <div className="text-center mt-6 space-y-2">
            <Link
              ...
              className="block text-sm text-gray-500 hover:text-premium-gold transition-colors"
            >

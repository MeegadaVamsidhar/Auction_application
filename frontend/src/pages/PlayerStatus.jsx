...
const PlayerStatus = () => {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-premium-dark flex items-center justify-center text-premium-gold">
        Loading...
      </div>
    );
      ...
      >
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-black text-white italic">
            MY <span className="text-premium-gold">STATUS</span>
          </h1>
          <button
            onClick={handleLogout}
            className="text-xs text-red-500 hover:text-red-400 border border-red-900/50 px-3 py-1 rounded"
          >
            LOGOUT
          </button>
        </div>
        ...
        {liveAuction && (
          ...
          >
            <div className="bg-black p-4 rounded text-center">
              <h3 className="text-premium-gold font-bold text-xl animate-bounce tracking-tighter uppercase">
                Live Auction Arena
              </h3>
              <div className="mt-4 grid grid-cols-2 gap-4">
                <div className="border-r border-gray-800">
                  ...
                  <p className="text-xl font-mono font-bold text-white italic">
                    ₹{liveAuction.currentPlayer?.basePrice || 0}L
                  </p>
                </div>
                <div>
                  <p className="text-gray-400 text-[10px] uppercase">
                  ...
                  <p className="text-xl font-mono font-bold text-premium-gold italic">
                    ₹
              ...
              <p className="text-[10px] text-gray-500 mt-4 uppercase tracking-widest">
                {liveAuction.highestBidderName
                  ? `Highest Bidder: ${liveAuction.highestBidderName}`
        ...
        {playerData && (
          <div className="bg-gradient-to-br from-gray-900 to-black border border-premium-border rounded-xl p-6 text-center">
            <h2 className="text-2xl font-bold mb-2">{playerData.name}</h2>
            <p className="text-sm opacity-50 mb-6 uppercase tracking-widest">
              {playerData.role}
            </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-bold text-premium-gold">
                    {playerData.team?.name || "Processing..."}
                  </p>
                </div>
                <div>
                  <p className="text-xs font-bold text-gray-400 uppercase mb-1">
